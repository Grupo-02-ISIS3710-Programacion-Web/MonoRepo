...
export class RutinasController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea una nueva rutina de cuidado de la piel asociada a un usuario. Requiere todos los campos obligatorios.',
  })
  @ApiBody({
        ...
        value: {
          ...
          steps: [
            ...
            },
            {
              ...
              order: 1,
              productId: '10',
              notes: 'Finalizar con protector solar',
            },
          ],
        },
      },
  ...
  create(@Body() createRutinaDto: CreateRutinaDto) {
    this.logger.log(
      `Solicitud recibida: POST /rutinas - Usuario ${createRutinaDto.userId}, rutina "${createRutinaDto.name}"`,
    );
    try {
      return this.rutinasService.create(createRutinaDto);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Lista todas las rutinas activas (no eliminadas) con paginación y opciones de ordenamiento.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      'Criterio de ordenamiento: newest (más recientes), mostCommented (más comentadas), mostVoted (más votadas)',
  ...
  findAll(
    ...
    this.logger.log(
      `Solicitud recibida: GET /rutinas - página ${page || '1'}, orden: ${sort || 'newest'}`,
    );
    try {
  ...
  @ApiOperation({
    ...
    description:
      'Lista todas las rutinas creadas por un usuario específico, ordenadas por número de visualizaciones.',
  })
  @ApiParam({
    name: 'userId',
  ...
  findByUserId(
    ...
    this.logger.log(
      `Solicitud recibida: GET /rutinas/user/${userId} - página ${page}`,
    );
    try {
      return this.rutinasService.findByUserId(userId, parseInt(page, 10));
    } catch (error) {
      this.logger.error(
        `Error en GET /rutinas/user/${userId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene los detalles completos de una rutina específica por su ID.',
  })
  @ApiParam({
    name: 'id',
  ...
  findOne(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Error en GET /rutinas/${id}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza parcial o totalmente una rutina existente. Solo se actualizan los campos proporcionados.',
  })
  @ApiParam({
    name: 'id',
  ...
  update(@Param('id') id: string, @Body() updateRutinaDto: UpdateRutinaDto) {
    ...
    try {
      ...
      this.logger.error(
        `Error en PATCH /rutinas/${id}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Realiza un borrado lógico de la rutina, marcándola como eliminada sin borrarla de la base de datos.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Rutina eliminada exitosamente (borrado lógico)',
  })
  @ApiResponse({ status: 404, description: 'Rutina no encontrada' })
  softDelete(@Param('id') id: string) {
    this.logger.log(
      `Solicitud recibida: DELETE /rutinas/${id} (borrado lógico)`,
    );
    try {
      return this.rutinasService.softDelete(id);
    } catch (error) {
      this.logger.error(
        `Error en DELETE /rutinas/${id}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Elimina la rutina permanentemente de la base de datos. Esta acción no se puede deshacer.',
  })
  @ApiParam({
    name: 'id',
  ...
  hardDelete(@Param('id') id: string) {
    this.logger.log(
      `Solicitud recibida: DELETE /rutinas/${id}/hardDelete (borrado físico)`,
    );
    try {
      return this.rutinasService.hardDelete(id);
    } catch (error) {
      this.logger.error(
        `Error en DELETE /rutinas/${id}/hardDelete: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Agrega un voto positivo de un usuario a la rutina. Si el usuario ya había votado negativo, se cambia a positivo. Si ya había votado positivo, se remueve el voto.',
  })
  @ApiParam({
    name: 'id',
  ...
  upvote(@Param('id') id: string, @Body('userId') userId: string) {
    this.logger.log(
      `Solicitud recibida: POST /rutinas/${id}/upvote - Usuario ${userId}`,
    );
    try {
      return this.rutinasService.upvote(id, userId);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas/${id}/upvote: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Agrega un voto negativo de un usuario a la rutina. Si el usuario ya había votado positivo, se cambia a negativo. Si ya había votado negativo, se remueve el voto.',
  })
  @ApiParam({
    name: 'id',
  ...
  downvote(@Param('id') id: string, @Body('userId') userId: string) {
    this.logger.log(
      `Solicitud recibida: POST /rutinas/${id}/downvote - Usuario ${userId}`,
    );
    try {
      return this.rutinasService.downvote(id, userId);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas/${id}/downvote: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Remueve el voto positivo de un usuario de la rutina, si existe.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Voto positivo removido exitosamente',
    type: Rutina,
  })
  @ApiResponse({ status: 404, description: 'Rutina no encontrada' })
  removeUpvote(@Param('id') id: string, @Body('userId') userId: string) {
    this.logger.log(
      `Solicitud recibida: POST /rutinas/${id}/remove-upvote - Usuario ${userId}`,
    );
    try {
      return this.rutinasService.removeUpvote(id, userId);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas/${id}/remove-upvote: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Remueve el voto negativo de un usuario de la rutina, si existe.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID de la rutina',
  ...
  @ApiResponse({
    status: 200,
    description: 'Voto negativo removido exitosamente',
    type: Rutina,
  })
  @ApiResponse({ status: 404, description: 'Rutina no encontrada' })
  removeDownvote(@Param('id') id: string, @Body('userId') userId: string) {
    this.logger.log(
      `Solicitud recibida: POST /rutinas/${id}/remove-downvote - Usuario ${userId}`,
    );
    try {
      return this.rutinasService.removeDownvote(id, userId);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas/${id}/remove-downvote: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  incrementView(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Error en POST /rutinas/${id}/view: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene el número de votos positivos, negativos y visualizaciones de una rutina.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID de la rutina',
  ...
  getVoteCounts(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Error en GET /rutinas/${id}/votes: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  getComments(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Error en GET /rutinas/${id}/comments: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  addComment(
    ...
    this.logger.log(
      `Solicitud recibida: POST /rutinas/${id}/comments - Usuario ${body.userId}`,
    );
    try {
      return this.rutinasService.addComment(id, body.userId, body.comment);
    } catch (error) {
      this.logger.error(
        `Error en POST /rutinas/${id}/comments: ${error.message}`,
        error.stack,
      );
      throw error;
    }
