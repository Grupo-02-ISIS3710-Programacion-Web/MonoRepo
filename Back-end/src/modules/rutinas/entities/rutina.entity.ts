...
export class RoutineStep {
  ...
  @ApiProperty({
    description:
      'Información del producto (opcional, se puede poblar desde la base de datos)',
    required: false,
  ...
  @ApiProperty({
    description:
      'Notas adicionales sobre cómo aplicar el producto en este paso',
    required: false,
...
export class Rutina extends Document {
  ...
  @ApiProperty({
    ...
    example:
      'Rutina sencilla de 3 pasos para comenzar el día con la piel limpia e hidratada.',
  })
  @Prop({ required: true })
  description: string;
