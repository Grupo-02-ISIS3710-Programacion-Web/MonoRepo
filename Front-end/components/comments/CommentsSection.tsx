...
export default function CommentSection({
  ...
  }, [localComments, onCommentsCountChange]);
    ...
    <Card className="border-secondary bg-secondary/10">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="rounded-xl border border-border bg-card">
          ...
          <p className="px-4 pt-4 text-lg font-semibold text-foreground">
            {t("thoughtsTitle")}
          </p>
          ...
          <div className="flex items-center justify-between rounded-b-xl border-t border-border bg-muted px-4 py-3">
            ...
            <Button
              onClick={addComment}
              className="h-9 rounded-xl bg-primary px-5 text-sm font-semibold text-primary-foreground hover:bg-secondary hover:text-secondary-foreground"
              disabled={!isLoggedIn}
            >
